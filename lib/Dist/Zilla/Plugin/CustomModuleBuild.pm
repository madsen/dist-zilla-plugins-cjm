...
CustomModuleBuild requires {{$t->dependency_link('Dist::Zilla')}} and
...
You write your own F<Build.PL> as usual, which may do anything
L<Module::Build> is capable of.
...
The CustomModuleBuild object that is processing the template.
